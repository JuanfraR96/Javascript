...
if (buscar != SALIR) {
    ...
    alert(`FACTURA ${facturas.indexOf(resultado)+1} con nombre ${resultado.nombre} y monto ${resultado.monto}. La factura con IVA es ${resultado.montoConIva}. El total de todo es ${total}. El total con IVA es ${total*1.21}`)
}